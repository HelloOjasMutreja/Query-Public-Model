...
ActiveRecord::Schema[7.0].define(version: 2023_01_29_212741) do
  ...
  create_table "daily_decision_lists", force: :cascade do |t|
    t.integer "user_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_daily_decision_lists_on_user_id"
  end

  create_table "daily_decisions", force: :cascade do |t|
    t.integer "user_id", null: false
    t.integer "query_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  add_foreign_key "daily_decision_lists", "users"
  add_foreign_key "daily_decisions", "queries"
  add_foreign_key "daily_decisions", "users"
